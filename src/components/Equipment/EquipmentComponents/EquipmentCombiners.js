...
class EquipmentCombiners extends Component {
  constructor(props) {
    super(props);
  }
          ...
          <div className="panel-body">
            <div className="row">
              <div className="col-md-12 tabHeader">
                <h4 className="tabHeaderText">COMBINERS</h4>
                <img className="tabHeaderLogo paddedImage" role="presentation" src='/images/equipment/Combiner_Icon.svg' height="35" width="50"/>
              </div>
            </div>
...
export default EquipmentCombiners;
