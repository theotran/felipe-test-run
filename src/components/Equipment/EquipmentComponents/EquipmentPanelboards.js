...
class EquipmentPanelboards extends Component {
  constructor(props) {
    super(props);
  }
          ...
          <div className="panel-body">
            <div className="row">
              <div className="col-md-12 tabHeader">
                <h4 className="tabHeaderText">PANELBOARDS</h4>
                <img className="tabHeaderLogo paddedImage" role="presentation" src='/images/equipment/Panelboard_Icon.svg' height="35" width="50"/>
              </div>
            </div>
...
// const OptimizersWithQuery = graphql(GetPanelsQuery, {
//   options: () => ({
//     fetchPolicy: 'cache-and-network'
//   })
// })(EquipmentOptimizers)

// export default OptimizersWithQuery;
export default EquipmentPanelboards;
