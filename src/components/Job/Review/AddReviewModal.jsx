...
class AddReview extends Component {
  ...
  handleSave = () => {
    this.props.mutate({variables: {type: this.state.type, belongsToId: this.props.belongsToId, belongsTo: this.props.belongsTo, isTPR: false}})
      .then((value) => {
  ...
  render() {
    ...
    return (
      <div>
        <Button color="teal" content={'ADD REVIEW'} icon='plus' labelPosition='left' onClick={(e, data) => {this.handleOpen()}} />
        <Dialog
          title="Add Review"
          actions={actions}
          modal={true}
            ...
            <div className="form-group col-md-6">
             ...
             {/* <div className='form-group col-md-6'>
               ...
               >
                 ...
                 <MenuItem value="In House" primaryText="In House"></MenuItem>
                 <MenuItem value="Customer" primaryText="Customer"></MenuItem>
               </SelectField>
             </div> */}
